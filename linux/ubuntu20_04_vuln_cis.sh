...
# Check Ubuntu Workstation CIS compliance:
...
oscap oval eval --report cis-report-$(date +"%d-%h-%y-%H-%M").html scap-security-guide-0.1.56-oval-5.10/ssg-ubuntu2004-ds-1.2.xml
xdg-open cis-report* > /dev/null
